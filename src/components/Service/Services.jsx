  ...
  return (
    <div className="services" id='Services'>
        <div className="awesome">
          ...
          <span>services</span>
          <span>
            I offer a complete range of <br/> full-stack development services, including frontend development, <br/> backend integration, and user interface design.
            <br />
            From building responsive and interactive web interfaces  <br/> to designing scalable backend systems,<br/> I ensure your application is seamless and efficient.
          </span>
          <a id='btn' href={pdf} download="Resume.pdf">
            <motion.button
            whileHover={{
                    scale: 1.1,
